...
- **Overview:**
  ...
  - **a pitch of his positions** (the spots of the position filter): in every position he can play, his rank there and his share of starting minutes in that spot, over the last 12 months or ever (our data runs from 2020/21). Ranks are per role group, so LB and RB share his full-back rank. A spot he has a rank for but no starts in (0%) is greyed out, and positions he has no rank in are hollow. Starting minutes are the role he started in, from the line-up and formation; minutes off the bench have no position and aren't counted;
